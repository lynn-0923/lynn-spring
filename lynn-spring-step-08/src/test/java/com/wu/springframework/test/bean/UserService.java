...
public class UserService implements BeanNameAware, BeanClassLoaderAware, ApplicationContextAware, BeanFactoryAware {
    ...
    private com.wu.springframework.test.bean.UserDao userDao;
    ...
    public com.wu.springframework.test.bean.UserDao getUserDao() {
        return userDao;
    }

    public void setUserDao(com.wu.springframework.test.bean.UserDao userDao) {
